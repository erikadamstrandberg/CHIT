...
class MEL_9000_k_images():
    ...
    def plot_image_and_x_cs(self, angle, n, y_pos, integrate_over):
        ...
        plt.tight_layout()
        plt.savefig(mypath/'Measurement_cyl_61.png', dpi=600, format='png')
...
plt.tight_layout()
plt.savefig(mypath/'GaAs4_1_crossection_x_61-65deg.png', dpi=600, format='png')
...
plt.xticks(fontsize = 15)
plt.tight_layout()
plt.savefig(mypath/'GaAs4_1_crossection_x_61-65deg_zoomed.png', dpi=600, format='png')
...
plt.xticks(fontsize = 15)
plt.tight_layout()
plt.savefig(mypath/'GaAs4_1_crossection_y_61-65deg.png', dpi=600, format='png')
...
plt.xticks(fontsize = 15)
plt.tight_layout()
plt.savefig(mypath/'GaAs4_1_crossection_y_61-65deg_zoomed.png', dpi=600, format='png')
